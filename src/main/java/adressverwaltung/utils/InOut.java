...
public class InOut {
    /**
     * Service connection which will be used to get data out of databases and the file sytem
     */
    ...
    /**
     * Prepares the connnection.&nbsp;Checks on all the variables to get the best connection
     * @param dotEnv List of preset values to get the chosen connection type
     * @throws SQLException If connected to the database without the needed permissions
     * @throws CanNotConnectToDatabaseError If all the values lead to a database which can not be accessed via the given inputs
     */
     ...
     * @throws Exception If not possible to write the export to the chosen location
     */
